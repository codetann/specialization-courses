...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 6, 2, 65);
    			attr_dev(a, "href", "https://svelte.dev/tutorial");
    			add_location(a, file, 8, 14, 108);
    			add_location(p, file, 7, 2, 90);
    			attr_dev(main, "class", "svelte-1cp0utu");
    			add_location(main, file, 5, 0, 56);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ name, pies });

    	$$self.$inject_state = $$props => {
    		if ('name' in $$props) $$invalidate(0, name = $$props.name);
    		if ('pies' in $$props) pies = $$props.pies;
    	};
